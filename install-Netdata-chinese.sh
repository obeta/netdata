...
# External files
PACKAGES_SCRIPT="https://ghproxy.com/https://raw.githubusercontent.com/netdata/netdata/master/packaging/installer/install-required-packages.sh"
...
set_tarball_urls() {
  ...
  if [ "$1" = "stable" ]; then
    local latest
    # Simple version
    latest="$(download "https://ghproxy.com/https://api.github.com/repos/netdata/netdata/releases/latest" /dev/stdout | grep tag_name | cut -d'"' -f4)"
    export NETDATA_TARBALL_URL="https://ghproxy.com/https://github.com/netdata/netdata/releases/download/$latest/netdata-$latest.tar.gz"
    export NETDATA_TARBALL_CHECKSUM_URL="https://ghproxy.com/https://github.com/netdata/netdata/releases/download/$latest/sha256sums.txt"
  else
...
DL="https://ghproxy.com/https://raw.githubusercontent.com/DX-Kevin/Netdata-chinese-patch/main/"
D="dashboard.js"
